...
class Privieges
{
    ...
    {
        $data = DB::table('zb_navigation')->get();
    ...
    {
        $res = DB::table('zb_navigation')->delete($id);
        return $res;
    }
    public static function deleteTypes($id)
    {
        $res = DB::table('zb_navigation')->whereIn('id',$id)->delete();
        return $res;
    }
    /**
     * 修改分类信的查询
    ...
    {
        $res = DB::table('zb_navigation')->where('id',$id)->first();
        return $res;
    }
    /**
     * 修改分类的信息
    ...
    {
        $res = DB::table('zb_navigation')->where('id',$id)->update($data);
        return $res;
    }
    ...
    {
        if ($data['status']=='0'){
            $res = DB::table('zb_navigation')->where('id',$data['id'])->increment('status','1');
        }else{
