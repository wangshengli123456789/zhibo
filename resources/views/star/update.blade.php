                ...
                <form action="" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="common-text required" id="title" name="telphone" size="50" value="{{$data->telphone}}" type="text">
                            </td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>参赛宣言：</th>
                            <td>
                                <input class="common-text required" id="title" name="content" size="50" value="{{$data->content}}" type="text">
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <input id="title" name="photos" type="hidden" value="{{$data->photo}}">
                            </td>
                        </tr>
                        <th></th>
                        <td>
