...
@section('content')
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/index">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/nav">轮播图管理</a><span class="crumb-step">&gt;</span><span>修改轮播图</span></div>
        </div>
