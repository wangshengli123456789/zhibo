    ...
    <div class="main-wrap">
        ...
        <div class="result-wrap">
            <div class="result-content">
                <form action="/adminupdate" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="common-text required" id="title" name="name" size="50" value="{{$info->name}}" type="text">
                            </td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>用户密码：</th>
                            <td>
                                <input class="common-text required" id="title" name="pwd" size="50" value="{{$info->pwd}}" type="password">
                            </td>
                        </tr>
