...
@section('content')
    ...
    <div class="main-wrap">
        ...
        <div class="crumb-wrap">
            <div class="crumb-list"><i class="icon-font"></i><a href="/index">首页</a><span class="crumb-step">&gt;</span><a class="crumb-name" href="/nav">联系我们</a><span class="crumb-step">&gt;</span><span>新增</span></div>
        </div>
                    ...
                    <table class="insert-tab" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div>
                                        ...
                                        <textarea name="content" id="editor" type="text/plain" style="width: 900px;height:500px;"></textarea></div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input class="common-text required" id="title" name="gzh" size="50" value="" type="text">
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td><textarea name="prompt" cols="50" rows="10" value=""></textarea></td>
                            </tr>
                            <tr>
