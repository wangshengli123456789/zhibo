                ...
                <form action="" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    <table class="insert-tab" width="100%">
                        ...
                        <tr>
                            ...
                            <td>
                                <div>
                                    ...
                                    <textarea name="hdjs" id="editor" type="text/plain" style="width: 700px;height:300px;">{{$data->hdjs}}</textarea></div>
                        ...
                        <tr>
                            ...
                            <td>
                                <input class="common-text required" id="title" name="message" size="50" value="{{$data->message}}" type="text">
                            </td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>奖项设置：</th>
                            <td>
                                <textarea name="jxsz" id="" cols="60" rows="10">{{$data->jxsz}}</textarea>
                            </td>
                        </tr>
                        <tr>
                            <th><i class="require-red">*</i>关于作弊：</th>
                            <td>
                                <textarea name="gyzb" id="" cols="60" rows="10">{{$data->gyzb}}</textarea>
                            </td>
                        </tr>
                        <th></th>
                        <td>
